{ lib, stdenv, requireFile, dpkg, xorg, libGL, udev, pulseaudio, libkrb5, zenity
, zlib, makeWrapper, godot3-mono, }:
stdenv.mkDerivation (finalAttrs: {
  ...
  preFixup = let
    ...
    libmonoNativeLibPath = lib.makeLibraryPath [ libkrb5 godot3-mono ];
  ...
  meta = {
    ...
    description =
      "A mapmaking tool for Tabletop Roleplaying Games, designed for battlemap scale";
